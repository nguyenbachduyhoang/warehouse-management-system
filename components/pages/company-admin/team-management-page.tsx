...
import { Plus, Search, Edit2, Trash2, ArrowLeft, LogOut, User, Mail, Shield } from "lucide-react"
...
export default function TeamManagementPage({ onBack, onLogout }: TeamManagementPageProps) {
