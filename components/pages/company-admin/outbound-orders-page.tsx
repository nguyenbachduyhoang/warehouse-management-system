...
interface OutboundOrdersPageProps {
  onBack: () => void
  onLogout: () => void
}

export default function OutboundOrdersPage({ onBack, onLogout }: OutboundOrdersPageProps) {
  ...
  return (
    <SectionLayout title="Outbound Orders" onBack={onBack} onLogout={onLogout}>
      {/* Header */}
