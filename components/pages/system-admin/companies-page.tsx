...
import { Plus, Search, Edit2, Trash2, ArrowLeft, LogOut, Building2, MoreVertical } from "lucide-react"
...
export default function CompaniesPage({ onBack, onLogout }: CompaniesPageProps) {
