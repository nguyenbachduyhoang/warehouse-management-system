...
import { ArrowLeft, LogOut, Shield, Lock, Key, Globe } from "lucide-react"
...
export default function SecurityPage({ onBack, onLogout }: SecurityPageProps) {
    return (
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="p-8 flex-1 overflow-auto max-w-4xl mx-auto w-full space-y-6">
