...
import { ArrowLeft, LogOut, Server, CheckCircle, AlertTriangle, Activity, Database, Cpu, Wifi, Shield } from "lucide-react"
...
export default function SystemStatusPage({ onBack, onLogout }: SystemStatusPageProps) {
    const services = [
